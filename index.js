...
var questions = [
	...
	new Question('Сколько знаешь подсадок на карте Vertigo', ['0-2', '3-4', '5-6', 'Больше 6']),
	// new Question('Сколько подсадок знаешь на карте Rialto', ['0-2', '3-4', '5-6', 'Больше 6']),
	new Question('Сколько существует подсадок на карте Nuke', ['0-1', '2-3', '4-5', 'Больше 5']),
	...
	new Question('Можно ли потерять всё здоровье, если упасть с большой высоты в игре', ['Да', 'Нет', 'Останется 1 хп', 'Не знаю']),
];
